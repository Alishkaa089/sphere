...
import { ArrowLeft, MapPin, Star, ShieldCheck, Square, BedDouble, Bath } from "lucide-react";
    ...
    <div className="min-h-screen bg-[#0a0a09] text-white">
      ...
      <div className="relative h-[65vh] md:h-[80vh] w-full mt-0 md:mt-0">
        ...
        <div className="absolute bottom-12 left-6 md:left-24 max-w-4xl pr-6">
          ...
          >
             <span className={`px-4 py-1.5 rounded-full text-xs font-black uppercase tracking-widest text-white border border-white/20 backdrop-blur-md shadow-2xl ${isSale ? 'bg-emerald-500/80' : 'bg-[#006B8A]/80'}`}>
          ...
          >
            <MapPin className="w-5 h-5" /> {property.city}, {property.country}
          </motion.div>
        </div>
      </div>
        ...
        <div className="lg:col-span-2">
            ...
            >
                <div className="bg-white/5 border border-white/10 rounded-2xl p-6 flex flex-col items-center justify-center text-center">
                    <BedDouble className="w-8 h-8 text-[#00A3CC] mb-3" />
                    <span className="text-3xl font-black text-white mb-1">{property.beds}</span>
                    <span className="text-xs font-bold text-slate-500 uppercase tracking-widest">{t.prop_beds}</span>
                </div>
                <div className="bg-white/5 border border-white/10 rounded-2xl p-6 flex flex-col items-center justify-center text-center">
                    <Bath className="w-8 h-8 text-[#00A3CC] mb-3" />
                    <span className="text-3xl font-black text-white mb-1">{property.baths}</span>
                    <span className="text-xs font-bold text-slate-500 uppercase tracking-widest">{t.prop_baths}</span>
                </div>
                <div className="bg-white/5 border border-white/10 rounded-2xl p-6 flex flex-col items-center justify-center text-center">
                    <Square className="w-8 h-8 text-[#00A3CC] mb-3" />
                    <span className="text-3xl font-black text-white mb-1">{property.area}</span>
            ...
            <div className="mb-16">
                ...
                <div className="prose prose-invert prose-lg text-slate-300 leading-relaxed font-medium">
                    ...
                    <div className="bg-[#002B38]/20 border border-[#006B8A]/20 rounded-2xl p-6 mb-8 flex items-start gap-4">
                        <ShieldCheck className="w-8 h-8 text-[#00A3CC] flex-shrink-0" />
                        <div>
                            <h4 className="text-lg font-black text-white mb-1">{t.det_inspect_badge}</h4>
                            <p className="text-sm text-[#CCF0FA] leading-relaxed">
                                {t.home_trust_desc}
                            </p>
                        </div>
                    </div>
            ...
            <div className="mb-16">
                ...
                <div className="w-full h-[400px] bg-zinc-900 rounded-3xl overflow-hidden relative border border-white/10 flex items-center justify-center">
                    ...
                    <div className="relative z-10 bg-black/60 backdrop-blur-xl border border-white/20 p-6 rounded-2xl text-center shadow-2xl">
                        ...
                        <h4 className="text-xl font-black text-white">{property.city}</h4>
