...
function HouseSVG() {
  return (
    <svg viewBox="0 0 480 320" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
      ...
      {/* ── WINDOWS ── */}
      {/* Left large floor-to-ceiling window */}
      ...
      {/* Subtle horizontal ground lights */}
      ...
      {/* Interior warm light cast on ground from windows */}
...
function CarSVG() {
  return (
    <svg viewBox="0 0 480 280" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
      ...
      {/* Main body shape — low sleek sports car */}
      <path d="
        M 85,200
        L 78,198
        L 78,175
